...
main {
    padding: 40px;
    text-align: center;
    margin-bottom: 80px; /* Añadir margen inferior para evitar solapamientos */
}
...
<nav class="navbar navbar-expand-lg navbar-dark">
    ...
    <main>
        ...
        <form>
            ...
            <ul>
                <li>📈 Sesiones de trading en vivo</li>
                <li>📚 Clases exclusivas y material de estudio</li>
                <li>💬 Asesoría personalizada y apoyo constante</li>
                <li>🚀 Estrategias y señales para maximizar tus ganancias</li>
                <li>🤖 ¡ACCESO A NUESTRO BOT EXCLUSIVO!</li>
            </ul>
            <h3>Paso 2: Depositar Fondos en tu Cuenta</h3>
            <p>Agrega fondos a tu cuenta para comenzar a operar con nosotros. El depósito es totalmente retirable en cualquier momento.</p>
            <p>Además, puedes obtener un bono del 50% sobre tu depósito usando el código: PAR245.</p>
